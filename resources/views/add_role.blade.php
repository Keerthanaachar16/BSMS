    ...
    <div class="container-fluid">
      <div class="page-title">
        <div class="row">
          ...
          <div class="col-12 col-sm-6">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="https://mcwaredemo.com/prismhnew/admin/dashboard"> <i data-feather="home"></i></a></li>
              <li class="breadcrumb-item"><a href="https://mcwaredemo.com/prismhnew/admin/role">Role</a></li>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="row needs-validation " novalidate="" method="post" action="https://mcwaredemo.com/prismhnew/admin/role">
                <input type="hidden" name="_token" value="gnjvQnENbLwFhVTUqPwlNjmWcFNijCKX1PS0ahvw">                <div class="col-sm-12">
                  <div class="mb-3">
                    <label for="validationCustom01">Name</label>
                    <input class="form-control" id="validationCustom01" type="text" name="name" placeholder="Add Role Title" required value="">
                  </div>
                  <div class="mb-3">
                    <div class="media">
                ...
                <div class="btn-showcase text-end">
                  ...
                  <a href="https://mcwaredemo.com/prismhnew/admin/role" class="btn btn-light">Cancel</a>
                </div>
              </form>
            </div>
          </div>
