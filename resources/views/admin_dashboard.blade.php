...
<div class="page-body">
  <div class="container-fluid">
    ...
    <div class="row  g-3 mb-4">
        <div class="col-md-4">
        <div class="card ">
                <h5>Total Complaints Received</h5>
                <div class="divider"></div>
                <div class="card-content-split">
                      <br><strong>{{ $totalComplaints }}</strong>
                </div>
            </div>
        </div>
            <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-content-split">
                    <div>
                        Resolved<br><strong>{{ $resolvedComplaints }}</strong>
                    </div>
                    <span class="vertical-divider"></span>
                    <div>
                        Pending<br><strong>{{ $pendingComplaints }}</strong>
                    </div>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-sm-6 mt-3 " >
                <!-- <div class="card" > -->
                    <h5 class="mb-3 text-center">Zone Wise Complaints</h5>
                    <div style="max-width:430px; margin:0 auto;">
                      <canvas id="zoneChart" height="170"></canvas>
                    </div>
                <!-- </div> -->
              </div>
        </div>
...
<script>
  ...
  // Create gradient backgrounds for a modern neon feel
  const gradients = [
    (() => { let g = ctx.createLinearGradient(0, 0, 0, 200); g.addColorStop(0, '#2f00ffff'); g.addColorStop(1, '#0072ff'); return g; })(), // Blue
    (() => { let g = ctx.createLinearGradient(0, 0, 0, 200); g.addColorStop(0, '#62fa34ff'); g.addColorStop(1, '#68ee2bff'); return g; })(), // Pink
    (() => { let g = ctx.createLinearGradient(0, 0, 0, 200); g.addColorStop(0, '#fcff3bff'); g.addColorStop(1, '#fffb17ff'); return g; })(), // Green
    (() => { let g = ctx.createLinearGradient(0, 0, 0, 200); g.addColorStop(0, '#fa5ee5ff'); g.addColorStop(1, '#ff00c8ff'); return g; })(), // Orange
    (() => { let g = ctx.createLinearGradient(0, 0, 0, 200); g.addColorStop(0, '#b319c7ff'); g.addColorStop(1, '#ba13c9ff'); return g; })(), // Purple
    (() => { let g = ctx.createLinearGradient(0, 0, 0, 200); g.addColorStop(0, '#06b2beff'); g.addColorStop(1, '#1b70a1ff'); return g; })(), // Aqua
    (() => { let g = ctx.createLinearGradient(0, 0, 0, 200); g.addColorStop(0, '#66faffff'); g.addColorStop(1, '#5efaffff'); return g; })(), // Coral
    (() => { let g = ctx.createLinearGradient(0, 0, 0, 200); g.addColorStop(0, '#56f2a9ff'); g.addColorStop(1, '#2fed7eff'); return g; })()  // Sky blue
  ];

  new Chart(ctx, {
    type: 'doughnut',
    data: {
      labels: @json(array_keys($zoneWiseData)),   // Zone names
      datasets: [{
        data: @json(array_values($zoneWiseData)), // Complaint totals
  ...
  new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        data: @json(array_values($zoneWiseData)), // Complaint totals
        backgroundColor: [
          '#59e5f7ff','#36a2eb','#ffcd56','#4bc0c0',
          '#916ed8ff','#ff9f40','#66ff66','#cc65fe'
        ],
        borderWidth: 1
      }]
    },
