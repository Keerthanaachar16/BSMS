        ...
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
                  ...
                  @endif
              <form class="row needs-validation " novalidate="" method="POST" action="{{ route('officials.store') }}">
                @csrf            
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="name"> Name</label>
                    <!-- <input class="form-control" id="name" type="text" name="name" placeholder="Enter Name" required value=""> -->
                ...
                <div class="col-sm-6">
                  <div class="mb-3">
                    ...
                    <!-- <input class="form-control" id="phone" type="number" name="phone" placeholder="Enter Phone Number" required value=""> -->
                     <input class="form-control" id="phone" type="number" name="phone" placeholder="Enter Phone Number" required>
                ...
                <div class="col-sm-6">
                  <div class="mb-3">
                    ...
                    <!-- <input class="form-control" id="email" type="email" name="email" placeholder="Enter Email" required value=""> -->
...
<script>
    $('#zone').change(function () {
        ...
        if(zone){
            $.post("{{ route('get.divisions') }}", {_token: '{{ csrf_token() }}', zone: zone}, function(data){
                data.forEach(function(div){
                    $('#division').append('<option value="'+div+'">'+div+'</option>');
                });
            });
        }
    });
    ...
    $('#division').change(function () {
        ...
        $('#ward').html('<option value="">-- Select Ward --</option>');
        if(division){
            $.post("{{ route('get.wards') }}", {_token: '{{ csrf_token() }}', zone: zone, division: division}, function(data){
