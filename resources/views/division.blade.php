          ...
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                ...
                <h4  class="mb-0 counter">{{$totalDivisions}}</h4>
              </div>
            </div>
    ...
    <div class="card">
      <div class="card-header pb-0">
        ...
        <div class="mb-3 text-end">
          ...
          <a href="{{ route('divisions.create') }}" class="btn btn-primary mb-3">Add </a>
        </div>
      </div>
      <div class="card-body">
        <div class="table-responsive">
          <table class="display table table-striped" id="divisionTable" style="width:100%">
            ...
            @forelse($divisions as $division)
                <tr>
                    <td>{{ $division->id }}</td>
                    <td>{{ $division->zone_name }}</td>
                    <td>{{ $division->div_name }}</td>
                    <td>{{ $division->latitude }}</td>
                    <td>{{ $division->longitude }}</td>
                    <td>
                        <a href="{{ route('divisions.edit', $division->id) }}" class="btn btn-outline-primary-2x">
            ...
            @empty
                <tr>
                    <td colspan="6" class="text-center">No Divisions Found</td>
                </tr>
            @endforelse
        </tbody>
          </table>
