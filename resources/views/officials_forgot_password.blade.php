...
<html lang="en">
  <head>
    <!-- Primary Meta Tags -->
    <title>officials_Forgot_Password</title>
    <!-- Meta -->
  ...
  <body class="theme-light" data-highlight="grass">
    ...
    <div id="page">
      <div class="page-content" style="padding-bottom:0px;">
        <div class="page-content" style="padding-bottom: 0px; transform: translateX(0px);">
          <div class="page-title page-title-small">
            <div class="text-left">
              <h2>
                 <a href="#" data-back-button><i class="fa fa-arrow-left"></i></a>Forgot password
              </h2>
            </div>
          </div>
      ...
      <form class="mt-2" method="POST" action="{{route('officials.sendOtp')}}">
        @csrf
      ...
      <div class="row justify-content-center mb-1">
        <div class="col-12 ps-0 footernemusub1">
          ...
          <div class="text-center mb-3">
            ...
            <a href="https://wa.me/984" target="_blank" class="a-green icon icon-xs rounded-sm shadow-l me-1 bg-whatsapp"><i class="fab fa-whatsapp"></i></a>
