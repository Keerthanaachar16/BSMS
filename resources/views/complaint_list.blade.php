                ...
                <form method="post" action="#" enctype='multipart/form-data'>
                        ...
                        <!-- <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4 mt-4">
                            ...
                            <div class="complaint-card" data-status="open">
                                ...
                                <div><strong>Description:</strong>Overflowing garbage bin</div>
                        ...
                        <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4 mt-4">
                            <a href="{{url('/complaint_details')}}" style="text-decoration:none; color:inherit;">
                            <div class="complaint-card" data-status="closed">
                                <div><strong>Complaint ID:</strong> C002</div>
                                <div><strong>Date:</strong> 2025-07-10</div>
                                <div><strong>Description:</strong>Daily waste not collected </div>
