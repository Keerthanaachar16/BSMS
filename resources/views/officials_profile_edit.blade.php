...
<html lang="en">
  <head>
    <!-- Primary Meta Tags -->
    <title>Officials/Profile_Edit</title>
    <!-- Meta -->
    ...
    <div id="page">
         <div class="page-title page-title-small">
                <h2>
                    ...
                    <span class="me-2 fw-bold">Profile_Edit</span>
  ...
  <div class="close-btn" onclick="closeProfileSidebar()">X</div>
    ...
    <div class="card card-style">
            <div class="content mb-0 mt-1 mb-3">
                <form method="POST" action="{{route('officials_profile.update')}}" enctype='multipart/form-data'>
                  @csrf
                        ...
                        <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4 mt-4">
                            ...
                            <input type="text" class="form-control validate-name" id="name" name="name" value="{{$official->name}}" required pattern="[A-Za-z\s]{3,}">
                        ...
                        <input type="email" class="form-control validate-name" id="email"  name="email" value="{{$official->email}}">
                        <i class="fa fa-times disabled invalid color-red-dark"></i>
                        <i class="fa fa-check disabled valid color-green-dark"></i>
                        </div>
