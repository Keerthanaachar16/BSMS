          ...
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                ...
                <h4  class="mb-0 counter">{{$totalWards}}</h4>
              </div>
            </div>
    ...
    <div class="card">
      <div class="card-header pb-0">
        ...
        <div class="mb-3 text-end">
          ...
          @endif
          <a href="{{ route('wards.create') }}" class="btn btn-primary mb-3">Add </a>
        </div>
      </div>
      <div class="card-body">
           ...
           <thead>
            ...
            <tbody>
              @forelse($wards as $ward)
                <tr>
                    <td>{{ $ward->id }}</td>
                    <td>{{ $ward->division_name }}</td>
                    <td>{{ $ward->ward_name }}</td>
                    <td>{{ $ward->ward_no }}</td>
                    <td>
                        <a href="{{ route('wards.edit', $ward->id) }}" class="btn btn-outline-primary-2x">
