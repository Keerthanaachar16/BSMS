    ...
    <!-- <div class="card card-style">
            <div class="content mb-0 mt-1 mb-3">
                <form method="post" action="#" enctype='multipart/form-data'> -->
                        ...
                        <div class="input-style1 input-style-always-active has-borders no-icon validate-field mb-4 mt-4">
                            <label for="date"><strong>Date of Complaint:</strong></label>
                            <span>2025-07-10</span>
                          </div>

                        <div class="input-style1 input-style-always-active has-borders no-icon validate-field mb-4 mt-4">
                        <label for="desc"><strong>Description:</strong></label>
                        <span>Daily waste not collected</span>
                      </div>
                        ...
                        <span>1200 1500</span>
                         ...
                         <div class="input-style2 input-style-always-active has-borders no-icon validate-field mb-4 mt-4">
                        <label for="img1"><strong>Image (after resolution):</strong></label><br>
                        <img src="{{ asset('storage/resolved_images/resolved1.jpg') }}" alt="Resolved Image">
                        </div>
