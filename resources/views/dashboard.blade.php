    ...
    <div class="content mb-2">
        ...
        <div class=" text-center d-flex flex-column gap-2">
            <div class="d-flex flex-row gap-2 m-0 justify-content-center">
                ...
                <div class=" text-center splide__slide d-flex flex-column w-48" >
                    <div class="bg-theme rounded-m shadow-m text-center pt-3 pb-3 pe-1 ps-1 flex-fill h-100">
                        <div class=" text-center d-flex align-items-center gap-1 flex-column h-100">
                ...
                <table class="table table-borderless text-center rounded-sm shadow-l" style="overflow: hidden;">
                    <thead>
                        <tr class="bg-gray-light">
                            <th scope="col" class="color-theme py-3 font-14 lh">Date</th>
                            <th scope="col" class="color-theme py-3 font-14 lh">Pending</th>
                            <th scope="col" class="color-theme py-3 font-14 lh">Progress</th>
                            <th scope="col" class="color-theme py-3 font-14 lh">Resolved</th>
