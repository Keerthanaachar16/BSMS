...
<div class="page-body">
  <div class="container-fluid">
      ...
      <div class="page-title mb-4">
        <div class="row">
          <div class="col-6">
            <h3 class="mt-3">Edit Division</h3>
          </div>
          <div class="col-6 text-end">
            ...
            <li class="breadcrumb-item active">
              <a href="{{ url('/divisions') }}">Divisions</a>
            </li>
            <li class="breadcrumb-item active">
              <a href="{{ url('/divisions/{id}/edit') }}">Edit</a>
            </li>
            </ol>
          </div>
        </div>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{ route('divisions.update', $division->id) }}" method="POST">
            ...
            <div class="row g-3">
               <div class="col-md-6">
                <label for="zone_select" class="form-label">Zone</label>
                <!-- <select id="zone" name="zone_name" class="form-select" required>
                <option value="">-- Select Zone --</option>
                <option value="East" {{ $division->zone_name=='East'?'selected':'' }}>East</option>
                <option value="West" {{ $division->zone_name=='West'?'selected':'' }}>West</option>
                <option value="South" {{ $division->zone_name=='South'?'selected':'' }}>South</option>
                <option value="Bommanahalli" {{ $division->zone_name=='Bommanahalli'?'selected':'' }}>Bommanahalli</option>
                <option value="Rajarajeshwari Nagar" {{ $division->zone_name=='Rajarajeshwari Nagar'?'selected':'' }}>Rajarajeshwari Nagar</option>
                <option value="Dasarahalli" {{ $division->zone_name=='Dasarahalli'?'selected':'' }}>Dasarahalli</option>
                <option value="Yelahanka" {{ $division->zone_name=='Yelahanka'?'selected':'' }}>Yelahanka</option>
                <option value="Mahadevapura" {{ $division->zone_name=='Mahadevapura'?'selected':'' }}>Mahadevapura</option>
                </select> -->
                <input type="text" class="form-control" id="zone"   value="{{ $division->zone_name }}" name="zone_name" >
              </div>
              <div class="col-md-6">
                <label for="div_name" class="form-label">Division Name</label>
                <!-- <select id="division" name="div_name" class="form-select" required>
                <option value="{{ $division->div_name }}" selected>{{ $division->div_name }}</option> -->
                 <input type="text" class="form-control" id="division"   value="{{ $division->div_name }}" name="div_name" >
            </select>
              </div>
              ...
              <div class="col-md-6">
                ...
                <input type="number" class="form-control" id="latitude"   value="{{ $division->latitude}}" name="latitude" readonly>
              </div>

              <div class="col-md-6">
                <label for="longitude" class="form-label">Longitude</label>
                <input type="number" class="form-control" id="longitude"  value="{{ $division->longitude}}" name="longitude" readonly>
              </div>
            </div>
