        ...
        <div class="row">
          ...
          <ol class="breadcrumb justify-content-end">
            ...
            <li class="breadcrumb-item active">
              <a href="{{ url('/officials') }}">Officials</a>
            </li>
            <li class="breadcrumb-item active">
              <a href="{{ url('/edit_user') }}">Edit</a>
            </li>
          </ol>
        </div>
        </div>
        ...
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="row needs-validation" novalidate method="POST" action="{{ route('officials.update', $official->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="name" type="text" name="name" value="{{ old('name', $official->name) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="phone" type="text" name="phone" value="{{ old('phone', $official->phone) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="email" type="email" name="email" value="{{ old('email', $official->email) }}" required>
                        </div>
                    </div>

                    <div class="col-sm-6">
                        <div class="mb-3">
                            <label for="zname">Zone</label>
                            <input class="form-control" id="zname" type="text" name="zname" value="{{ old('zname', $official->zone) }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="div" type="text" name="div" value="{{ old('div', $official->division) }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="ward" type="text" name="ward" value="{{ old('ward', $official->ward) }}">
                        </div>
                    </div>
