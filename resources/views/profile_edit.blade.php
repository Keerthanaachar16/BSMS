                ...
                <form method="POST" action="{{route('profile.update')}}" enctype='multipart/form-data'>
                  @csrf
                        ...
                        <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4 mt-4">
                            ...
                            <input type="text" class="form-control validate-name" id="name" name="name" value="{{$user->name}}" required pattern="[A-Za-z\s]{3,}">
                        ...
                        <input type="email" class="form-control validate-name" id="email"  name="email" value="{{$user->email}}">
                        <i class="fa fa-times disabled invalid color-red-dark"></i>
                        <i class="fa fa-check disabled valid color-green-dark"></i>
                        </div>
                        ...
                        <textarea class="form-control validate-name" id="address" rows="2"  name="address" >{{$user->address}}</textarea>
                        <i class="fa fa-times disabled invalid color-red-dark"></i>
                        <i class="fa fa-check disabled valid color-green-dark"></i>
                        </div>
                        <center>
