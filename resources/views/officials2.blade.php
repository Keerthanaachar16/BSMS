        ...
        <ul class="sidebar-links" id="simple-bar">
          <li class="back-btn">
           ...
           <li class="sidebar-list">
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="{{ url('/reports') }}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g>
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="{{ url('/officials') }}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                      ...
                      </svg><span>Officials Management</span></a>
                  </li>
              </div>
          ...
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                <h6 class="font-roboto">Officials</h6>
                        ...
                        <div class="media-body text-center switch-sm">
                            <label class="switch">
                                <input type="checkbox" 
                                       ...
                                       onchange="changeStatus({{ $official->id }})">
                                <span class="switch-state"></span>
                            </label>
                        </div>
                    </td> -->
                    <td style="display:flex;gap:10px;">
                        <a href="{{ url('view_user/'.$official->id) }}" class="btn btn-outline-primary-2x">
                            <i class="bi bi-eye"></i>
                        </a>
                        <a href="{{ url('edit_user/'.$official->id) }}" class="btn btn-outline-primary-2x">
                          <i class="icon-pencil-alt"></i>
                        </a>
                        <!-- Delete -->
                        <form action="{{ url('delete_user/'.$official->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this official?')" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-outline-primary-2x">
