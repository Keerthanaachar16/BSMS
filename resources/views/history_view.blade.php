    ...
    <div id="page">
         <div class="page-title page-title-small">
                <h2>
                    ...
                    <span class="me-2 fw-bold">View_History</span>
        ...
        <form method="post" action="#" enctype='multipart/form-data'>
            ...
            <div class="input-style2 input-style-always-active has-borders no-icon validate-field mb-4 mt-4">
                ...
                @if($complaint->image)
                    <img src="{{ asset('complaint_images/' . $complaint->image) }}" 
                         alt="Complaint Image" style="max-width:80%; height:60%;">
                @else
            ...
            <div class="input-style2 input-style-always-active has-borders no-icon validate-field mb-4 mt-4">
                ...
                @if($complaint->updated_image)
                    <img src="{{ asset($complaint->updated_image) }}" alt="updated Image" width="200">
                @else
