    ...
    <div id="page">
         <div class="page-title page-title-small">
                <h2>
                    ...
                    <span class="me-2 fw-bold">Check_Complaints</span>
  ...
  <div class="close-btn" onclick="closeProfileSidebar()">X</div>
    ...
    <div class="card card-style">
            <div class="content mb-0 mt-1 mb-3">
                <form method="GET" action="{{route('check_complaints')}}" enctype='multipart/form-data'>
                    @csrf     
                    ...
                    @if($complaint)
                        <div class="card1">
                            ...
                            @if($complaint->image) 
                                ...
                                <img src="{{ asset('complaint_images/'.$complaint->image) }}" alt="Complaint Image" style="max-width: 80%; height:80%;">
                            @endif
                        </div>
                    @else
...
<nav class="navbar  navbar-light ">
    <div class="container-fluid d-flex justify-content-around text-center">
        ...
        <!-- Complaints -->
        <a href="{{ url('/complaints') }}" class="text-decoration-none text">
            <div>
        ...
        <!-- Home -->
        <a href="{{ url('/dashboard') }}" class="text-decoration-none text">
            <div>
