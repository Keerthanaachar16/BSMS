...
<html lang="en">
  <head>
    <!-- Primary Meta Tags -->
    <title>Offcials_complaints</title>
    <!-- Meta -->
    ...
    <div id="page">
         <div class="page-title page-title-small">
                <h2>
                    ...
                    <span class="me-2 fw-bold">Complaints_List</span>
            ...
            <div class="content mb-0 mt-1 mb-3">
                <form method="GET" action="#" enctype='multipart/form-data'>
                    @csrf     
                      <div class="card mb-3">
                        <div class="card-body">
                            <strong>Complaint ID:</strong> 1 <br>
                            <strong>Description:</strong> abc<br>

                            
                            <div class="d-flex gap-2 mt-2">
                            <a href="{{ url('/official_complaints_view') }}" class="btn btn-primary btn-sm">View</a>
                            <a href="https://www.google.com/maps/dir/?api=1&destination=12.9716,77.5946" 
                                target="_blank" class="btn btn-success btn-sm">Get Directions</a>
                            </div>
                        </div>
                        </div>
 ...
 -->
    ...
    <div class="card card-style">
        <div class="content mb-0 mt-1 mb-3">
            @forelse($complaints as $complaint)
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="d-flex gap-2 mt-2">
                            <a href="{{ url('/official_complaints_view/' . $complaint->id) }}" class="btn btn-primary btn-sm">View</a>
                            <a href="https://www.google.com/maps/dir/?api=1&destination=12.9716,77.5946"
                               target="_blank" class="btn btn-success btn-sm">Get Directions</a>
                        </div>
                    </div>
            ...
            @empty
                <p class="text-center text-danger">No complaints assigned to you yet.</p>
            @endforelse
        </div>
    </div>
</div> -->
        ...
        @foreach($complaints as $complaint)
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 mt-2">
                        <!-- <a href="{{ url('/official_complaints_view/'.$complaint->id) }}" class="btn btn-primary btn-sm">View</a> -->
                        <a href="{{ route('official_complaints.show', $complaint->id) }}" class="btn btn-primary btn-sm">View</a>
                        <a href="https://www.google.com/maps/dir/?api=1&destination=12.9716,77.5946"
                           target="_blank" class="btn btn-success btn-sm">Get Directions</a>
                    </div>
                </div>
