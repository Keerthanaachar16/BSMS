              ...
              <form class="row needs-validation " novalidate="" method="post" action="">
                ...
                <div class="col-sm-6">
                  <div class="mb-3">
                    ...
                    <input class="form-control" id="cid" type="text" name="cid" required value="">
                  </div>    
                </div>
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="desc">Description</label>
                    <input class="form-control" id="desc" type="text" name="desc" required value="">
                  </div>    
                </div>
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="lat">Latitute</label>
                    <input class="form-control" id="lat" type="email" name="lat"  required value="">
                  </div>    
                </div>
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="long">Longitude</label>
                        <input class="form-control" id="long" type="text" name="long"  required value="">
                  </div>    
                </div>
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="status">Status</label>
                    <input class="form-control" id="status" type="text" name="status"  required value="">
                  </div>    
                </div>
                </form>
            </div>
