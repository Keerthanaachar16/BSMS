      ...
      <div class="card-body">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="ward_name" name="ward_name" placeholder="" value="{{$ward->ward_name}}">
            </div>

            <div class="col-md-6">
              <label for="ward_no" class="form-label">Ward Number</label>
              <input type="number" class="form-control" id="ward_no" name="ward_no" placeholder="" value="{{$ward->ward_no}}">
            </div>


            <div class="col-md-6">
              <label for="division" class="form-label">Division</label>
              <input type="text" class="form-control" id="division_name" name="division_name" placeholder="" value="{{$ward->division_name}}">
            </div>
          </div>
