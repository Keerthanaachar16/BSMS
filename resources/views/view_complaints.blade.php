...
<html lang="en">
  <head>
    ...
    <title>Complaint_Management/View</title>
   <!-- Fonts -->
...
.complaint-card {
    ...
    border-radius: 12px;
    /* box-shadow: 0 4px 20px rgba(178, 155, 231, 0.8); */
    max-width: 900px;
    width: 100%;
    padding: 30px;
    border-top: 10px solid #4A00E0;
    border-bottom: 10px solid #4A00E0;
        ...
        .complaint-card li {
            ...
            /* box-shadow: 0 2px 10px rgba(178, 155, 231, 0.8); */
        }
      ...
      <div class="page-title">
        <div class="row">
          ...
          <ol class="breadcrumb justify-content-end">
            ...
            <li class="breadcrumb-item active">
              <a href="{{ url('/view_complaints') }}">View</a>
            </li>
          </ol>
        </div>
        </div>
    ...
    <div class="container-fluid">
      <div class="row">
                ...
                <form class="row needs-validation" novalidate method="post" action="">
                  ...
                  <!-- <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                        <strong>Complaint Image:</strong><br>
                        <img src="{{ asset('complaint_images/'.$complaint->image) }}" 
                            alt="Complaint Image" 
                            class="img-fluid rounded shadow mt-2" style="max-width:300px;">
                        </li>
                        @endif

                        @if(!empty($complaint->updated_image))
                        <li class="list-group-item">
                        <strong>Updated Image:</strong><br>
                        <img src="{{ asset($complaint->updated_image) }}" 
        ...
        <ul>
            ...
            <li><strong>Latitude:</strong> {{ $complaint->latitude }}</li>
            <li><strong>Longitude:</strong> {{ $complaint->longitude }}</li>
            <li><strong>Status:</strong>
                ...
                @else
                    <span class="badge badge-secondary">{{ ucfirst($complaint->complaint_status) }}</span>
                @endif
            </li>
            <li><strong>Ward:</strong> {{ $complaint->ward }}</li>
            <li><strong>Remarks:</strong> {{ $complaint->remarks ?? '—' }}</li>

            @if(!empty($complaint->image))
            <li>
                <strong>Complaint Image:</strong><br>
                <img src="{{ asset('complaint_images/'.$complaint->image) }}" alt="Complaint Image">
            </li>
            @endif

            @if($complaint->complaint_status == 'Resolved' && !empty($complaint->updated_image))
            <li>
                <strong>Resolved Image:</strong><br>
                <img src="{{ asset($complaint->updated_image) }}" alt="Updated Complaint Image">
            </li>
            @endif
            <li><strong>Complaint Date&Time:</strong> {{ $complaint->created_at }}</li>
            <li><strong>Updated Date&Time:</strong> {{ $complaint->updated_at }}</li>
        </ul>
