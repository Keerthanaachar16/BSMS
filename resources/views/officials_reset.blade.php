        ...
        <div class="page-content" style="padding-bottom: 0px; transform: translateX(0px);">
          ...
          <div class="card card-style">
            <div class="content mb-0 mt-1 mb-3">
                <form method="POST" action="{{route('officials.resetPassword')}}" enctype='multipart/form-data'>
                  @csrf  
      ...
      <div class="row justify-content-center mb-1">
        <div class="col-12 ps-0 footernemusub1">
          ...
          <div class="text-center mb-3">
            ...
            <a href="https://wa.me/91" target="_blank" class="a-green icon icon-xs rounded-sm shadow-l me-1 bg-whatsapp"><i class="fab fa-whatsapp"></i></a>
