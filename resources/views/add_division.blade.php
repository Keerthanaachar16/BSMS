      ...
      <div class="page-title">
        <div class="row">
          ...
          <ol class="breadcrumb justify-content-end">
            ...
            <li class="breadcrumb-item active">
              <a href="{{ url('/divisions/create') }}">Add</a>
            </li>
          </ol>
        </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="row needs-validation " novalidate=""  action="{{ route('divisions.store') }}" method="POST">              
                @csrf
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="zone_name">Zone</label>
      
                        <select id="zone" name="zone_name" class="form-control" required>
                ...
                <div class="col-sm-6">
                  ...
                  <!-- <select id="division" name="div_name" class="form-control" required>
                      <option value="">-- Select Division --</option>
                  </select> -->
                  <input class="form-control" id="div_name" type="text" name="div_name" placeholder="Enter Division Name" required value="">
                </div>
                   </div>
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="latitude">Latitude</label>
                    <input class="form-control" id="latitude" type="number" name="latitude" placeholder=" Division Latitude" required value="">
                  </div>    
                </div>
                ...
                <div class="col-sm-6">
                  <div class="mb-3">
                    ...
                    <input class="form-control" id="longitude" type="number" name="longitude" placeholder=" Division Longitude" required value="">
                  </div>    
                </div>
...
const divisionsByZone = {
    "East": ["C V Raman Nagar", "Hoysala Nagar", "Jeevan Bima Nagar"],
    "West": ["Mahalakshmi Layout", "Malleswaram", "Rajajinagar"],
    "South": ["Basavanagudi", "Jayanagar", "Banashankari"],
    "Bommanahalli": ["BTM Layout", "HSR Layout", "Madivala"],
    "Rajarajeshwari Nagar": ["Kengeri", "Ullal", "Nagarabhavi"],
    "Dasarahalli": ["Peenya", "Bagalagunte", "T Dasarahalli"],
    "Yelahanka": ["Byatarayanapura", "Jakkur", "Yelahanka"],
    "Mahadevapura": ["KR Puram", "Mahadevapura", "Whitefield"]
};

// Populate divisions when zone changes
document.getElementById('zone').addEventListener('change', function() {
    const zone = this.value;
    const divisionSelect = document.getElementById('division');
    divisionSelect.innerHTML = '<option value="">-- Select Division --</option>';
    if (divisionsByZone[zone]) {
        divisionsByZone[zone].forEach(d => {
...
// Fetch lat/lng from OSM when division selected
document.getElementById('division').addEventListener('change', async function() {
    const division = this.value;
    if (division) {
        const response = await fetch(`https://nominatim.openstreetmap.org/search?format=json&q=${division},Bangalore`);
