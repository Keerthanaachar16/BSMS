...
<div class="page-body">
  <div class="container-fluid">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            @forelse ($complaint as $index => $complaint)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td>{{ $complaint->id }}</td>
                    ...
                    <td>{{ ucfirst($complaint->complaint_status) }}</td>
                    <td>
                        <a href="{{ route('complaints.assign', $complaint->id) }}" class="btn btn-sm btn-primary">Assign</a>
                        <a href="{{ route('complaints.view', $complaint->id) }}" class="btn btn-sm btn-info">View</a>
                    </td>
                </tr>
            @empty
                <tr>
