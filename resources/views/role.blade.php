        ...
        <ul class="sidebar-links" id="simple-bar">
          <li class="back-btn">
           ...
           <li class="sidebar-list">
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="{{ url('/admin_dashboard') }}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g>
          ...
          <div class="card-body">
            ...
            <div class="progress-widget">
              <div class="progress sm-progress-bar progress-animate">
                <div class="progress-gradient-secondary" role="progressbar" style="width:100%" aria-valuenow="11" aria-valuemin="0" aria-valuemax="11"><span class="animate-circle"></span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card o-hidden">
          <div class="card-body">
            ...
            <div class="progress-widget">
              <div class="progress sm-progress-bar progress-animate">
                <div class="progress-gradient-success" role="progressbar" style="width: 100%" aria-valuenow="11" aria-valuemin="0" aria-valuemax="11"><span class="animate-circle"></span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card o-hidden">
          <div class="card-body">
            ...
            <div class="progress-widget">
              <div class="progress sm-progress-bar progress-animate">
                <div class="progress-gradient-danger" role="progressbar" style="width: 0%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="11"><span class="animate-circle"></span></div>
              </div>
            </div>
          </div>
        </div>
              ...
              <tr>
                      ...
                      <td>
                        <div class="media-body text-center switch-sm">
                            <label class="switch">
                            <input type='checkbox' checked onchange="changeStatus(3)">
                      ...
                      <td>
                        <a href="{{url('/edit_role')}}"  class="btn btn-outline-primary-2x"><i class="icon-pencil-alt"></i></a>
                    </td>
                    </tr>
                    <tr>
                      <td>2</td>
                      ...
                      <td>
                        <div class="media-body text-center switch-sm">
                            <label class="switch">
                            <input type='checkbox' checked onchange="changeStatus(4)">
                            <span class="switch-state"></span>
                          </label>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="media-body text-center switch-sm">
                            ...
                            <input type='checkbox' checked onchange="changeStatus(5)">
                            <span class="switch-state"></span>
                          </label>
