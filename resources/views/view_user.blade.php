                ...
                <form class="row needs-validation" novalidate method="post" action="">
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control" id="name" type="text" name="name" value="{{ $official->name }}" readonly>
                    </div>    
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control" id="phone" type="text" name="phone" value="{{ $official->phone }}" readonly>
                    </div>    
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control" id="email" type="email" name="email" value="{{ $official->email }}" readonly>
                    </div>    
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control" id="zname" type="text" name="zname" value="{{ $official->zone ?? '' }}" readonly>
                    </div>    
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control" id="div" type="text" name="div" value="{{ $official->division ?? '' }}" readonly>
                    </div>    
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control" id="ward" type="text" name="ward" value="{{ $official->ward ?? '' }}" readonly>
                    </div>    
                  </div>
              </form>
            </div>
