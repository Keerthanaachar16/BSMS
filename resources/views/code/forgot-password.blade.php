  ...
  <body class="theme-light" data-highlight="grass">
    ...
    <div class="content mt-2 mb-0">
      <form class="mt-2" method="get" action="#">
        <input type="hidden" name="_token" value="S0pQqq83On2q9uFmFfo90ZPUURnudvbIcSYTcmtn">        <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
