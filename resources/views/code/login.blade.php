        ...
        <div class="card card-style">
          ...
          <div class="content mt-2 mb-0">
            ...
            <div class="d-flex justify-content-between">
              <div><a href="{{url('/register')}}" class="p-2 bg-green-dark rounded-sm">Registration</a></div>
              <div><a href="{{url('/forgot-password')}}" class="p-2 bg-green-dark rounded-sm">Forgot Password</a></div>
            </div>
          </div>
        </div>
          ...
          <div class="footer card card-style mx-0 mb-0">
            <div class="content mb-4 text-center">
              ...
              <p class="boxed-text-l">
                For technical support WhatsApp <a href="https://wa.me/919066798311">9066798311</a>
              </p>
            </div>
